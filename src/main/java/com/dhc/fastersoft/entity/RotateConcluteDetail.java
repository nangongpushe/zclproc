...
public class RotateConcluteDetail {
	...
	@Excel(name="粮食产地",needMerge = true)
	private String produceArea;
	@Excel(name="生产年度",needMerge = true)
	...
	@Excel(name="交货起始时间",needMerge = true)
	private String deliveryStart;
	@Excel(name="交货截止时间",needMerge = true)
	...
	private BigDecimal surplusPlanNumber;
	...
	public BigDecimal getSurplusPlanNumber() {
		return surplusPlanNumber;
	}

	public void setSurplusPlanNumber(BigDecimal surplusPlanNumber) {
		this.surplusPlanNumber = surplusPlanNumber;
	}
}
