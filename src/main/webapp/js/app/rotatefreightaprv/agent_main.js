...
Main.prototype={
    ...
    renderLayTable:function(){
        ...
        layui.table.render({
            ...
            url:"../rotateFreightAPRV/agentList.shtml",
            method:"POST",
            request : {
                pageName : 'pageIndex',
                limitName : 'pageSize'
    ...
    add:function(){
        location.href="../rotateFreightAPRV/agent_add.shtml";
    },
    show:function(data) {
    ...
    edit:function(data){
        location.href = "../rotateFreightAPRV/agent_edit.shtml?sid="+ data.id;
    },
    updateStatus:function(data,status){
        ...
        layer.confirm(tip, {
            ...
            $.ajax({
                url:"../rotateFreightAPRV/updateAgentStatus.shtml",
                type:"POST",
                data:postData,
