        ...
        <div class="layui-form" id="search">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline ">
                    ...
                    <div class="layui-input-inline ">
                        <input type="text" lay-verify="required" class="layui-input" value="${purchaseDept}" readOnly
                               name="purchaseDept" id="purchaseDept" autocomplete="off">
                    </div>
                </div>
                <div class="layui-inline ">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <input type="text" lay-verify="number|customNumber" readonly="readonly" style="background:#CCCCCC" class="layui-input" name="totalAmount"
                               id="totalAmount" autocomplete="off" maxlength="8">
                ...
                <div class="layui-inline ">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" lay-verify="required" class="layui-input" readOnly value="${purchaseMan}"
                               name="purchaseMan" id="purchaseMan" autocomplete="off">
                    </div>
                </div>
                <div class="layui-inline ">
                    <label class="layui-form-label"><span class="red">*</span>申购日期:</label>
                    <div class="layui-input-inline">
                        <input type="text" lay-verify="required" class="layui-input" name="purchaseDate"
                               id="purchaseDate"
                               autocomplete="off">
                    </div>
                </div>
            ...
            <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-inline" style="width:75%">
                    <textarea lay-verify="required" placeholder="--限500字--" maxlength="500" name="purchaseReason"
            ...
            <button type="button" class="layui-btn layui-btn-primary layui-btn-small" onclick="addMaterialName();">
                新增明细
            </button>
...
<script>
    ...
    function addMaterialName() {
        var tr = '<tr id="addtr"><td style="width:6%" ><input type="hidden" name="purchaseId" style="width:0px;"/><a href="javascript:void(0);" class="layui-btn layui-btn-primary layui-btn-small" onclick="toDelete(this);">删除</a>	</td>'
            ...
            + '<td  name="income"><input onblur ="sumPic(this);" type="text" name="quantity"  maxlength="5" id="quantity" lay-verify="number|customNumber" class="layui-input"   placeholder="" onkeyup="value=value.replace(/[^\\d]/g,\'\')"/></td>'
            + '<td ><input type="text" name="unitPrice" lay-verify="number|customNumber" onBlur="checkAmounts(this);" maxlength="5" class="layui-input"   placeholder=""  onkeyup="value=value.replace(/[^\\d{1,}\\.\\d{1,}|\\d{1,}]/g,\'\')"/></td>'
            + '<td  name="expend"><input onblur ="sumPic(this);" type="text" name="estimatedUnitPrice" maxlength="5" id="estimatedUnitPrice" lay-verify="number|customNumber" class="layui-input"  placeholder=""  onkeyup="value=value.replace(/[^\\d{1,}\\.\\d{1,}|\\d{1,}]/g,\'\')"/></td>'
        ...
        for (var i=0;i<quantityList.length;i++){
            ...
            if (quantity!=null&&quantity!=''&&estimatedUnitPrice!=null&&estimatedUnitPrice!=''){
                ...
                /*if ((quantity==null||quantity=='')&&(estimatedUnitPrice!=null&&estimatedUnitPrice!='')){
                    ...
                    return;
                }else if ((estimatedUnitPrice==null||estimatedUnitPrice1=='')&&(quantity!=null&&quantity!='')){
    ...
    var purchaseDate = new Date().Format("yyyy-MM-dd");
