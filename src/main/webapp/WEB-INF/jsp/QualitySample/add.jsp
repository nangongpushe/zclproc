        ...
        <table class="table table-bordered">
            ...
            <tbody>
             <tr>
                    ...
                    <td><input type="text" lay-verify="required" maxlength="50" autocomplete="off" name="sampleNo" id="sampleNo" value="${QualitySample.sampleNo }"  class="form-control validate[required]" placeholder="--请输入--" onchange="check();"/></td>
                ...
                <tr>
                    ...
                    <td>
                    	...
                    	<input type="text" autocomplete="off" readonly="readonly" lay-verify="required" tag="model" name="sampleSouce" value="${QualitySample.sampleSouce }" warehouseid="${QualitySample.warehouseId}" warehouseType="id" class="form-control validate[required]" placeholder="--请选择--"/>

						<a type="button" class="btn btn-link" <c:if test="${!(isEdit )}"> style="display: none" </c:if> id="chooseBtn" data-target="#myModal" data-bind="click:function(){$root.showModal($data);}">选择</a>
                ...
                <tr>
                    ...
                    <td>
   						<%--<input type="text" lay-verify="required"  name="variety" id="variety" readonly="readonly" value="${QualitySample.variety }" class="form-control validate[required]" placeholder="--自动带出--"/>--%>
                            <select class="form-control validate[required]" name="variety" id="variety" disabled>
                                <option value="">--自动带出--</option>
                                <c:forEach items="${variety}" var="item">
                                    <option value="${item.value}" <c:if test="${QualitySample.variety == item.value}">selected</c:if> >${item.value}</option>
                                </c:forEach>
                            </select>
                ...
                <tr>
                    ...
                    <td><input type="text" lay-verify="required"  name="harvestYear" id="harvestYear" readonly="readonly" value="${QualitySample.harvestYear }" class="form-control validate[required]"autocomplete="off" placeholder="--自动带出--"/></td>
                	<td class="text-right"><b> 产地:</b></td>
                    <td>
   						<input type="text" name="origin" id="origin" readonly="readonly" class="form-control" value="${QualitySample.origin }" autocomplete="off" placeholder="--自动带出--"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text"  maxlength="15" name="samplingPeople" autocomplete="off"  value="${QualitySample.samplingPeople }" class="form-control" placeholder="--请输入--"/></td>
                    <td class="text-right"><span class="red">*</span><b> 入库年月:</b></td>
                    <td><input type="text"  name="inStoreYear" autocomplete="off" id="inStoreYear" value="${QualitySample.inStoreYear }" class="form-control validate[required]" placeholder="--请输入--"/></td>
...
// 		 }
		...
		$.ajax({
			url:"../rotateConclute/listDetailForSample.shtml",
			type:"POST",
			data:{
            ...
            $.ajax({
                ...
                success:function(data){
                    if(data!=""){
                        ...
                        // $("#variety option:selected").removeAttr("selected");
                        // $("#variety").find("option[value='"+qualtitySample.variety+"']").attr("selected",true);

						$("select[name='variety']").val(qualtitySample.variety);
                        ...
                        $("#variety option:selected").removeAttr("selected");
                        $("#variety").find("option[value='"+vm.curDeal.grainType+"']").attr("selected",true);
                        ...
                        $("select[name='variety']").val(vm.curDeal.grainType);
