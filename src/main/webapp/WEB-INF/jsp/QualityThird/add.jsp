...
<div class="row clear-m">
    ...
    <div class="container-box clearfix" style="padding: 10px">
        <!--检验结果表-->
        <form class="form_input layui-form" id="form_input" action="save.shtml" method="post"
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <input maxlength="50" tag="model" type="text" name="reportUnit" id="reportUnit"
                               value='${entity.reportUnit }' class="form-control" placeholder="" readonly/>
                ...
                <tr>
                    ...
                    <td><input id="testDate" name="testDate" class="form-control " type="text"
                               value="${entity.testDate }"/></td>

                    <td class="text-right"><span class="red">*</span><b>检验日期截止日期:</b></td>
                    <td><input type="text" id="testEndDate" name="testEndDate" value='${entity.testEndDate }'
                ...
                <table class="layui-table" id="in">
                    ...
                    <c:forEach items="${entityItem}" var="entityItem">
                        <tr>
                            ...
                            <td colspan="1"><input maxlength="20" type="text" value='${entityItem.standard }' id="standard" name="standard" class="form-control validate[required] " placeholder=""/>
    ...
    layui.form.on('select(sampleNo)',function(data){
        ...
        for(var i=0;i<qualitySamples.length;i++) {
            if (qualitySamples[i].sampleNo == sampleNo) {
                ...
                $("input[name='storeDate']").val(qualitySamples[i].inStoreYear);
