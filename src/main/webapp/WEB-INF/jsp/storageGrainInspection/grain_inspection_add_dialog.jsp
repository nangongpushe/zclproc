    ...
    <form class="layui-form" id="form" lay-filter="form">
        ...
        <div class="layui-form-item">
            <div class=" layui-inline">
                ...
                <div class="layui-input-inline">
                    ...
                    />
                    <input lay-verify="required" class="layui-input form-control" autocomplete="off" name="warehouse" readonly
            ...
            <div class=" layui-inline">
                ...
                <div class="layui-input-inline">
                    <input lay-verify="required" type="text" class="layui-input date-need"
                           placeholder="&#45;&#45;请选择&#45;&#45;" name="reportDate" value="<fmt:formatDate value='${grainInspection.reportDate }' type='date' pattern='yyyy-MM-dd'/>" readonly/>
                </div>
            </div>
            <div class=" layui-inline">
        ...
        <div class=" layui-form-item">
            <div class=" layui-inline">
                ...
                <div class="layui-input-inline">
                    <input lay-verify="number" type="text" id="actualAmount1" maxlength="10" oninput="optionProperties1(this.id);" onkeyup="clearNoNum(this);" onblur="checkAmounts(this);"   style="background:#CCCCCC" step="0.1" class="layui-input" name="quantity" value="${grainInspection.quantity }" placeholder="--请输入--"/>
                </div>
            </div>
            <div class=" layui-inline">
                <label class="layui-form-label"><span class="red" id="wt1">*</span>仓温（℃）：</label>
                <div class="layui-input-inline">
                    <input lay-verify="required" id="bg101" type="text" maxlength="5" onkeyup="clearNoNum(this);" onblur="checkAmounts(this);" step="0.1" class="layui-input" placeholder="--请输入--"
        ...
        <div class=" layui-form-item">
            <div class=" layui-inline">
                <label class="layui-form-label"><span class="red" id="at1">*</span>气温（℃）：</label>
                <div class="layui-input-inline">
                    <input lay-verify="required" id="bg102" type="text" maxlength="5" onkeyup="clearNoNum(this);" onblur="checkAmounts(this);" step="0.1" class="layui-input" placeholder="--请输入--"
                           name="temperature" value="${grainInspection.temperature }"/>
                </div>
            </div>
            <div class=" layui-inline">
                <label class="layui-form-label"><span class="red" id="wet1">*</span>仓湿（RH%）：</label>
                <div class="layui-input-inline">
                    <input lay-verify="required" id="bg103" type="text" onkeyup="clearNoNum1(this);" onblur="checkAmounts(this);" class="layui-input" placeholder="--请输入--"
        ...
        <div class=" layui-form-item">
            <div class=" layui-inline">
                <label class="layui-form-label"><span class="red" id="qet1">*</span>气湿（RH%）：</label>
                <div class="layui-input-inline">
                    <input lay-verify="required" id="bg104" type="text" onkeyup="clearNoNum1(this);" onblur="checkAmounts(this);" step="0.1" class="layui-input" placeholder="--请输入--"
                           name="airWet" value="${grainInspection.airWet }"/>
                </div>
            </div>

            <div class=" layui-inline">
                <label class="layui-form-label"><span class="red" id="gva1">*</span>粮食品种：</label>
                <div class="layui-input-inline">
                    <select name="grainType" lay-verify="required" lay-filter="grainType" id="bg105">
        ...
        <div class=" layui-form-item">
            <div class=" layui-inline">
                ...
                <div class="layui-input-inline">
                    <input lay-verify="required" type="text" maxlength="5" class="layui-input" placeholder="--请输入--"
...
<script>
    ...
    if ('${auvp }' !== 'a') {
        if($('#actualAmount1').val() == '0'){
            document.getElementById("wt1").style.display = "none";
            $('#bg101').attr('lay-verify', null);
            document.getElementById("at1").style.display = "none";
            $('#bg102').attr('lay-verify', null);
            document.getElementById("wet1").style.display = "none";
            $('#bg103').attr('lay-verify', null);
            document.getElementById("qet1").style.display = "none";
            $('#bg104').attr('lay-verify', null);
            document.getElementById("gva1").style.display = "none";
            $('#bg105').attr('lay-verify', null);
        }
                ...
                success : function(result) {
                    ...
                    if (result.success) {
                        if(result.data == 'null'){
                            ...
                            document.getElementById("wt1").style.display = "";
                            $('#bg101').attr('lay-verify','required');
                            document.getElementById("at1").style.display = "";
                            $('#bg102').attr('lay-verify','required');
                            document.getElementById("wet1").style.display = "";
                            $('#bg103').attr('lay-verify','required');
                            document.getElementById("qet1").style.display = "";
                            $('#bg104').attr('lay-verify','required');
                            document.getElementById("gva1").style.display = "";
                            $('#bg105').attr('lay-verify','required');
