...
/*  .zTreeDemoBackground {width:100%;  overflow:auto;} */
		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input maxlength="20" class="layui-input" lay-verify="required" autocomplete="off" id="templetName" name="templetName">
				</div>
			</div>
			<div class="layui-inline">
			...
			<div class="layui-form-item">
				...
				<label class="layui-form-label" style="text-align:right"><span class="red"></span>备注：</label>
		    	  ...
		    	  <textarea   placeholder="--限250字--" maxlength="250" name="remark" class="layui-textarea"></textarea>
		    	</div>
			</div>
		</div>	
