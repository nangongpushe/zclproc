...
<div class="container-box clearfix" style="padding: 10px">
    ...
    <script type="text/html" id="barDemo">
        ...
        <%--{{#  } }}--%>
        {{#  if(d.status =="待审核" ){ }}
        <shiro:hasPermission name="RotateFreightAPRV:pass">
        <a class="layui-btn layui-btn-primary layui-btn layui-btn-mini" lay-event="pass">同意</a>
        </shiro:hasPermission>
        {{#  } }}
        {{#  if(d.status == "待汇总"){ }}
...
<script src="${ctx}/js/app/rotatefreightaprv/agent_main.js"></script>
