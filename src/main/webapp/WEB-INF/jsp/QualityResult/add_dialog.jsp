        ...
        <form class="form_input layui-form" id="form_input"  action="save.shtml" method="post" enctype="multipart/form-data" lay-filter="form1">
            ...
            <table class="table table-bordered">
                    ...
                    <td colspan="3">
                        <c:if test="${auvp!='v'}">
                            <select lay-verify="required" class="form-control"   name="sampleNo" id="sampleNo" lay-search lay-filter="sampleNo" >
                                ...
                                <c:forEach items="${qualitySamples}" var="qualitySample">
                                    <option value="${qualitySample.sampleNo}" warehouseId="${qualitySample.warehouseId}" sampleNo="${qualitySample.id}">${qualitySample.sampleNo}</option>
                                </c:forEach>
                            </select>
                        </c:if>
                        <c:if test="${auvp=='v'}">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <c:if test="${empty entity.storeEncode}">
                ...
                <tr>
                    ...
                    <td>
                        <select lay-verify="required" class="form-control "  name="storeType" id="storeType">
                            <option value="">--请选择--</option>
                            <c:forEach items="${storeType}" var="storeType1">
                                <c:if test="${storeType1.value eq entity.storeType }">
                                    <option value="${storeType1.value}" selected="selected" >${storeType1.value}</option>
                                </c:if>
                                <c:if test="${storeType1.value ne entity.storeType }">
                                    <option value="${storeType1.value}" >${storeType1.value}</option>
                                </c:if>
                            </c:forEach>
                        </select>
                    </td>
            ...
            <div class="manage">
                <table class="layui-table" id="tableId">
                    ...
                    <!-- 表格内容start -->
                    <tbody id="Detail">
                    <c:forEach items="${entityItem}" var="entityItem1">
                        <tr id="addtr" class="addtr">
                            <td colspan="1">${entityItem1.itemName }<input readonly="readonly" style="text-align: left" type="hidden" value='${entityItem1.itemName }' id="itemName" name="itemName" class="form-control validate[required] "placeholder=""/></td>
                            <input readonly="readonly" type="hidden" value='${entityItem1.orderNo }' id="orderNo" name="orderNo" class="form-control validate[required] "placeholder=""/>
                            <td colspan="1"><input readonly="readonly" type="text" value='${entityItem1.grade }' id="grade" name="grade" class="form-control "placeholder=""/></td>
                            <td colspan="1"><input readonly="readonly" type="text" value='${entityItem1.standard }' id="standard" name="standard" class="form-control validate[required] "placeholder=""/></td>
                                <%-- <td colspan="1"><input type="text" value='${entityItem.result }' name="result" class="form-control validate[required] "placeholder=""/>--%>

                            <td colspan="1"><textarea rows="1" name="result" class="form-control" placeholder="" maxlength="125">${entityItem1.result }</textarea></td>
                            <td colspan="1"><input type="text" value='${entityItem1.remark }' id="remark" name="remarkItem" class="form-control  "placeholder=""/>
                                <input type="hidden" value='${entityItem1.resultId }' id="resultId" name="resultId" style="width:0px;"/></td>
