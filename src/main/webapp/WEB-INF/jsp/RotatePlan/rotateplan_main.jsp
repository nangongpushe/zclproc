...
<!-- 			<div class="layui-inline">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input class="layui-input" name="documentNumber"  autocomplete="off">
				</div>
			</div> -->
			<div class="layui-inline">
	...
	<script type="text/html" id="barDemo">
		...
		<shiro:hasPermission name="RotatePlan:edit">
		 ...
		 <shiro:hasPermission name="RotatePlan:distribute">
			 <a class="layui-btn layui-btn layui-btn-mini" lay-event="distribute">分发</a>
		 </shiro:hasPermission>
		 {{#  } }}
		 {{#  if(d.state =="已分发"){ }}
		 	<a class="layui-btn layui-btn layui-btn-mini" lay-event="reject">驳回</a>
		 {{#  } }}
		 <%--{{#  if(d.state =="待分发"){ }}--%>
		 <shiro:hasPermission name="RotatePlan:edit">
		...
		<a href="../rotatePlan/exportExcel.shtml?id={{d.id}}" class="layui-btn layui-btn layui-btn-mini" id="exportExcel">导出</a>
		</shiro:hasPermission>
  	</script>
</div>

<script src="${ctx}/js/knockout-3.4.0.js"></script>
<script src="${ctx}/js/app/rotateplan/main.js"></script>
