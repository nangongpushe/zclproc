...
//                    return;
    ...
    function loadReport(month){
        ...
        if(reportName == '储备粮油收支月报表'){
            url = "${ctx}/reportCbly/"+toDo+"ProxyCbly.shtml";
        }else if(reportName == '商品粮油收支月报表'){
            url = "${ctx}/reportSply/"+toDo+"ProxySply.shtml";
        }else if(reportName == '销往省外'){
            url = "${ctx}/reportXwsw/"+toDo+"ProxyXwsw.shtml";
        }else if(reportName == '省外购进'){
            url = "${ctx}/reportXwsw/"+toDo+"ProxyXwsw.shtml";
        }else if(reportName == '粮油库存实物台账月报表'){
            url = "${ctx}/reportSwtz/"+toDo+"ProxySwtz.shtml";
        }else if(reportName == '库存包装物出入库明细表'){
            url = "${ctx}/reportBzwcrmx/"+toDo+"ProxyBzwcrmx.shtml";
        }
        else{
            url = "${ctx}/reportBzw/"+toDo+"ProxyBzw.shtml";
        }
            ...
            function (responseText,textStatus) {
                ...
                if(textStatus == 'success'){
                    if(dataList){
                        ...
                        if(reportName == '储备粮油收支月报表' || reportName == '商品粮油收支月报表' || reportName == '销往省外' ||
                            reportName == '省外购进'){
                            //自动计算
                            autoSum();
                        }
