...
<div class="container-box clearfix" style="padding: 10px">
 	 <div class="layui-form" id="search" >
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				<label class="layui-form-label"><span class="red"></span>原"四化"状态：</label>
					<div class="layui-input-inline">
    ...
    <div class="manage">
         <p class="btn-box" style="padding-top:0px;margin-left:10px;">
        	 <shiro:hasPermission name="StorageFourUnit:add">  
            <button type="button" class="layui-btn layui-btn-primary layui-btn-small " onclick="window.location.href='${ctx }/StorageFourUnit/add.shtml?'">新增</button>
              </shiro:hasPermission>
...
<script>
	...
	table.render({
		elem : '#mytable',
		url : '${ctx}/StorageFourUnit/list.shtml?type=1',
		method:'POST',
		cols : [[
			...
			{field : 'oldLevel',title : '原"四化"状态',width:120,align:'center'},
			{field : 'applyLevel',title : '现"四化"状态',width:180,align:'center'},
	...
	table.on('tool(test)', function(obj) {
		...
		if (obj.event === 'detail') {
			...
			location.href = "${ctx}/StorageFourUnit/view.shtml?id="
					+ data.id;
		} else if (obj.event === 'del') {
			layer.confirm('确定删除吗？', function(index) {
				$.post("${ctx}/StorageFourUnit/remove.shtml", {
					id : data.id
				}, function(result) {
			...
			location.href = "${ctx}/StorageFourUnit/edit.shtml?id="
					+ data.id;
		}else if (obj.event === 'export') {
            window.location.href="${ctx }/StorageFourUnit/exportxls.shtml?id="+data.id;
        }
	...
	function exportxls(){
		...
		window.location.href="${ctx }/StorageFourUnit/exportxls.shtml?warehouseId="+warehouseId+"&postalAddress="+postalAddress+"&oldLevel="+oldLevel+"&type="+'1';
