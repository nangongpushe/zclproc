         ...
         <input type="hidden" name="storeHouse"  value="${storageStarUnit.storeHouse}"/>
      	...
      	<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input class="layui-input" lay-verify="customNumber"  autocomplete="off" maxlength="9"  value="${storageStarUnit.entireStaff}"   id="entireStaff" name="entireStaff">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="text-align:right"><span class="red"></span>有职业资格证书人员(人)：</label>
				<div class="layui-input-inline">
					<input class="layui-input"  lay-verify="customNumber"  autocomplete="off"  maxlength="9"  value="${storageStarUnit.nvq}"   id="nvq" name="nvq">
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input class="layui-input" lay-verify="customNumber" autocomplete="off"  maxlength="9"  value="${storageStarUnit.juniorCollege}"   id="juniorCollege" name="juniorCollege">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="text-align:right"><span class="red"></span>中级（含）以上职称(人)：</label>
				<div class="layui-input-inline">
					<input class="layui-input" lay-verify="customNumber"  autocomplete="off" maxlength="9"  value="${storageStarUnit.mediumGrade}"   id="mediumGrade" name="mediumGrade">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="text-align:right"><span class="red"></span>粮油保管员(人)：</label>
				<div class="layui-input-inline">
					<input class="layui-input"  lay-verify="customNumber"  autocomplete="off"  maxlength="9"  value="${storageStarUnit.keeper}"   id="keeper" name="keeper">
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input class="layui-input" lay-verify="customNumber" autocomplete="off"  maxlength="9"  value="${storageStarUnit.monitor}"   id="monitor" name="monitor">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="text-align:right"><span class="red"></span>粮仓机械员(人)：</label>
				<div class="layui-input-inline">
					<input class="layui-input" lay-verify="customNumber"  autocomplete="off" maxlength="9"  value="${storageStarUnit.mechanic}"   id="mechanic" name="mechanic">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="text-align:right"><span class="red"></span>中央控制室操作员(人)：</label>
				<div class="layui-input-inline">
					<input class="layui-input"  lay-verify="customNumber"  autocomplete="off"  maxlength="9"  value="${storageStarUnit.controlOperator}"   id="controlOperator" name="controlOperator">
				</div>
			</div>
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input class="layui-input" lay-verify="customNumber" autocomplete="off"  maxlength="9"  value="${storageStarUnit.electrician}"   id="electrician" name="electrician">
				</div>
			</div>
			<div class="layui-inline">
				<label class="layui-form-label" style="text-align:right"><span class="red"></span>安全生产管理员(人)：</label>
				<div class="layui-input-inline">
					<input class="layui-input" lay-verify="customNumber"  autocomplete="off" maxlength="9"  value="${storageStarUnit.safety}"   id="safety" name="safety">
				</div>
			</div>
			<div class="layui-inline">
					...
					<select class="layui-input" lay-verify="required"  name="oldLevel" lay-filter="aihao"
						...
						<c:if test="${storageStarUnit.oldLevel == '是'}"    >
              			 	 <option selected="selected" value="是">是</option>
          				 </c:if>
          				 <c:if test="${storageStarUnit.oldLevel != '是'}"    >
              			 	 <option  value="是">是</option>
          				 </c:if>
          				 <c:if test="${storageStarUnit.oldLevel == '否'}"    >
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<select class="layui-input" lay-verify="required"  name="applyLevel" lay-filter="aihao"
						...
						<c:if test="${storageStarUnit.applyLevel == '是'}"    >
              			 	 <option selected="selected" value="是">是</option>
          				 </c:if>
          				 <c:if test="${storageStarUnit.applyLevel != '是'}"    >
              			 	 <option  value="是">是</option>
          				 </c:if>
          				 <c:if test="${storageStarUnit.applyLevel == '否'}"    >
              			 	 <option selected="selected" value="否">否</option>
          				 </c:if>
          				 <c:if test="${storageStarUnit.applyLevel != '否'}"    >
              			 	 <option  value="否">否</option>
			...
			<div class="layui-form-item">
						...
						<label style=" width: 100px;text-align: right " class="layui-form-label"><span class="red"></span>备注:</label>
				    	  ...
				    	  <textarea   placeholder="--限450字--" maxlength="400" name="remark" class="layui-textarea">${storageStarUnit.remark}</textarea>
				    	</div>
			</div>
      </div>
   	...
   	$(".form_input").ajaxSubmit({
				...
				success:function(data){
				    if(data.success){
                        ...
                        layer.msg("保存失败",{icon:2}, function(){
                            location.href="${ctx}/StorageFourUnit.shtml";
                        })
					}
				}
