...
<div class="row clear-m">
    <ol class="breadcrumb">
        ...
        <li>粮油情检测管理</li>
        <li>氮气浓度检测记录</li>
        <li class="active">${gaslog.id eq null ? '新增' : '复制'}</li>
    </ol>
</div>
    ...
    <form class="layui-form" lay-filter="search" id="data-form">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-inline layui-col-md5">
                ...
                <div class="layui-input-inline">
                    <input type="text" maxlength="20" name="detectionOperation" lay-verify="required" autocomplete="off" class="layui-input form-control" value='${gaslog.detectionOperation }'>
                </div>
            </div>
        </div>
        <div class="layui-row title">
        ...
        <table class="layui-table" id="temp">
            ...
            <c:forEach items="${storageGaslogTemps}" var="storageGaslogTemp" varStatus="idxStatus">
                ...
                <tr><td style="width:6%;text-align: left" ><input type="hidden" name="storageGaslogTemp[${idxStatus.index}].placeId" value="${storageGaslogTemp.placeId}"lay-verify="" style="width:0px;"/><span class="red">*</span>${idxStatus.count}</td>
                    <td ><input type="text" maxlength="5" onkeyup="clearNoNum(this);" onblur="checkAmounts(this);"  name="storageGaslogTemp[${idxStatus.index}].testing" value="${storageGaslogTemp.testing}"  class="layui-input" lay-verify="required" placeholder="--请输入--"/></td>
            ...
            <td colspan="3"><input type="text" maxlength="5" onkeyup="clearNoNum(this);" onblur="checkAmounts(this);" lay-verify="required" name="testingavg" class="layui-input" placeholder="--请输入--" value="${gaslog.testingavg }" /></td>
        </table>
        ...
        <div class="layui-form-item layui-form-text">
            <div class="layui-inline layui-col-md5">
                ...
                <div class="layui-input-inline">
                    <input readonly type="text" name="detectionHumen" lay-verify="required" autocomplete="off" class="layui-input form-control" value='${gaslog.detectionHumen }'>
                </div>
            </div>
        </div>
        <div class="layui-form-item text-center">
            <button type="button" lay-submit class="layui-btn layui-btn-primary layui-btn-small" id="submit">${gaslog.id eq null ? '保存':'保存'}</button>
...
<script>
    ...
    $("#submit").click(function(){
        ...
        $("#data-form").ajaxSubmit({
            url:"${ctx}/StorageGaslog/${gaslog.id eq null ? 'Add':'editadd'}.shtml",
            type:"post",
            data:{
                "id":"${gaslog.id}"
            },
